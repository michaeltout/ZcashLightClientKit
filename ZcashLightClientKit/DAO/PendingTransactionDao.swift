...
class PendingTransactionSQLDAO: PendingTransactionRepository {
    ...
    struct TableColumns {
        static var toAddress = SQLite.Expression<String>("to_address")
        static var accountIndex = SQLite.Expression<Int>("account_index")
        static var minedHeight = SQLite.Expression<Int?>("mined_height")
        static var expiryHeight = SQLite.Expression<Int?>("expiry_height")
        static var cancelled = SQLite.Expression<Int?>("cancelled")
        static var encodeAttempts = SQLite.Expression<Int?>("encode_attempts")
        static var errorMessage = SQLite.Expression<String?>("error_message")
        static var submitAttempts = SQLite.Expression<Int?>("submit_attempts")
        static var errorCode = SQLite.Expression<Int?>("error_code")
        static var createTime = SQLite.Expression<TimeInterval?>("create_time")
        static var raw = SQLite.Expression<Blob?>("raw")
        static var id = SQLite.Expression<Int>("id")
        static var value = SQLite.Expression<Int>("value")
        static var memo = SQLite.Expression<Blob?>("memo")
        static var rawTransactionId = SQLite.Expression<Blob?>("txid")
    }
